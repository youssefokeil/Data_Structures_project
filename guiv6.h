...
namespace GUIproject {
	...
	private: String^ GetCurrentContent() {
				// Example: If the content is in a TextBox control, return its text
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(340, 477);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {//check
		panel1->Show();
		bool result = false;
		result = XMLValidator::XMLValidator::IsXMLValid(selectedFilePath);
		...
		if (result) {
			...
			label2->Text = "The XML file is NOT valid";
			label2->Font = (gcnew System::Drawing::Font(L"Arial", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {//compress
		panel2->Show();
		CompressionCLI::CompressionManager::Compress(selectedFilePath, outputFilePath);
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {//decompress
		panel3->Show();
		CompressionCLI::CompressionManager::Decompress(selectedFilePath, outputFilePath);
	}
